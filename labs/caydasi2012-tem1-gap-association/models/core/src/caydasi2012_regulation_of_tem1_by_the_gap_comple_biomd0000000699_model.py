...
"""TelluriumSBMLBioModule wrapper for Caydasi2012 - Regulation of Tem1 by the GAP complex in spindle position cell cycle checkpoint - Ubiquitous association model.

Source: biomodels_ebi:BIOMD0000000699
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000699
"""
...
class SbmlCaydasi2012RegulationOfTem1ByTheGapComplexIn2(TelluriumSBMLBioModule):
    """BioModule wrapper for SBML model: Caydasi2012 - Regulation of Tem1 by the GAP complex in spindle position cell cycle checkpoint - Ubiquitous association model."""

    _SBML_ID = 'BIOMD0000000699'
    _TITLE = 'Caydasi2012 - Regulation of Tem1 by the GAP complex in spindle position cell cycle checkpoint - Ubiquitous association model'
    ...
    _PARAMETER_INPUTS = {
        'active_bfa1_at_the_spb': ('Active_Bfa1_at_the_SPB', 4.51479948255e-16, 'native SBML value', 'Controls Active Bfa1 At The SPB. Maps to SBML symbol `Active_Bfa1_at_the_SPB`.'),
        'active_bfa1_at_the_cytosol': ('Active_Bfa1_at_the_Cytosol', 1.2224947245000003e-10, 'native SBML value', 'Controls Active Bfa1 At The Cytosol. Maps to SBML symbol `Active_Bfa1_at_the_Cytosol`.'),
        ...
        'inactive_bfa1_at_the_spb': ('Inactive_Bfa1_at_the_SPB', 0.0, 'native SBML value', 'Controls Inactive Bfa1 At The SPB. Maps to SBML symbol `Inactive_Bfa1_at_the_SPB`.'),
        'inactive_bfa1_in_the_cytosol': ('Inactive_Bfa1_in_the_cytosol', 0.0, 'native SBML value', 'Controls Inactive Bfa1 In The Cytosol. Maps to SBML symbol `Inactive_Bfa1_in_the_cytosol`.'),
    }
    _HEADLINE_OUTPUTS = {
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000699.xml', integration_step: float = 0.01) -> None:
...
Caydasi2012RegulationOfTem1ByTheGapCompleBiomd0000000699Model = SbmlCaydasi2012RegulationOfTem1ByTheGapComplexIn2
