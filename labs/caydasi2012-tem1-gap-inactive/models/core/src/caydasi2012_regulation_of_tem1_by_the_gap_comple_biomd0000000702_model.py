...
"""TelluriumSBMLBioModule wrapper for Caydasi2012 - Regulation of Tem1 by the GAP complex in Spindle Position Checkpoint - Ubiquitous inactive model.

Source: biomodels_ebi:BIOMD0000000702
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000702
"""
...
class SbmlCaydasi2012RegulationOfTem1ByTheGapComplexIn(TelluriumSBMLBioModule):
    """BioModule wrapper for SBML model: Caydasi2012 - Regulation of Tem1 by the GAP complex in Spindle Position Checkpoint - Ubiquitous inactive model."""

    _SBML_ID = 'BIOMD0000000702'
    _TITLE = 'Caydasi2012 - Regulation of Tem1 by the GAP complex in Spindle Position Checkpoint - Ubiquitous inactive model'
    ...
    _PARAMETER_INPUTS = {
        ...
        'active_tem1_at_the_spb': ('Active_Tem1_at_the_SPB', 2.7099636749999997e-17, 'native SBML value', 'Controls Active Tem1 At The SPB. Maps to SBML symbol `Active_Tem1_at_the_SPB`.'),
        ...
        'inactive_bfa1_at_the_spb': ('Inactive_Bfa1_at_the_SPB', 4.78579585005e-16, 'native SBML value', 'Controls Inactive Bfa1 At The SPB. Maps to SBML symbol `Inactive_Bfa1_at_the_SPB`.'),
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000702.xml', integration_step: float = 0.01) -> None:
...
Caydasi2012RegulationOfTem1ByTheGapCompleBiomd0000000702Model = SbmlCaydasi2012RegulationOfTem1ByTheGapComplexIn
