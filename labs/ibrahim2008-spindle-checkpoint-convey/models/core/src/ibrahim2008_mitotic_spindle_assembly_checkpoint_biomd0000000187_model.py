...
"""TelluriumSBMLBioModule wrapper for Ibrahim2008 - Mitotic Spindle Assembly Checkpoint - Convey variant.

Source: biomodels_ebi:BIOMD0000000187
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000187
"""
...
class SbmlIbrahim2008MitoticSpindleAssemblyCheckpointConvey(TelluriumSBMLBioModule):
    """BioModule wrapper for SBML model: Ibrahim2008 - Mitotic Spindle Assembly Checkpoint - Convey variant."""

    _SBML_ID = 'BIOMD0000000187'
    _TITLE = 'Ibrahim2008 - Mitotic Spindle Assembly Checkpoint - Convey variant'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000187.xml', integration_step: float = 0.01) -> None:
...
Ibrahim2008MitoticSpindleAssemblyCheckpointBiomd0000000187Model = SbmlIbrahim2008MitoticSpindleAssemblyCheckpointConvey
