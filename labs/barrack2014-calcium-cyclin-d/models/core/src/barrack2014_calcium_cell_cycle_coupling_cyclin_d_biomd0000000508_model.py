...
"""TelluriumSBMLBioModule wrapper for Barrack2014 - Calcium/cell cycle coupling - Cyclin D dependent ATP release.

Source: biomodels_ebi:BIOMD0000000508
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000508
"""
...
class SbmlBarrack2014CalciumCellCycleCouplingCyclinDDependent(TelluriumSBMLBioModule):
    """BioModule wrapper for SBML model: Barrack2014 - Calcium/cell cycle coupling - Cyclin D dependent ATP release."""

    _SBML_ID = 'BIOMD0000000508'
    _TITLE = 'Barrack2014 - Calcium/cell cycle coupling - Cyclin D dependent ATP release'
    ...
    _HEADLINE_OUTPUTS = {
        ...
        'dcon': ('dcon', 'native SBML value', 'Tracks Dcon. Maps to SBML symbol `dcon`.'),
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000508.xml', integration_step: float = 0.01) -> None:
...
Barrack2014CalciumCellCycleCouplingCyclinDBiomd0000000508Model = SbmlBarrack2014CalciumCellCycleCouplingCyclinDDependent
