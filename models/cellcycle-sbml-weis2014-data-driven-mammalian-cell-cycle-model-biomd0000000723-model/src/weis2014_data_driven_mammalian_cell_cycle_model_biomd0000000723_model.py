...
"""Auto-generated SBML BioModule wrapper for Weis2014 - Data driven Mammalian Cell Cycle Model.
...
class SbmlWeis2014DataDrivenMammalianCellCycleModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Weis2014 - Data driven Mammalian Cell Cycle Model."""

    def __init__(self, model_path: str = "data/BIOMD0000000723.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
