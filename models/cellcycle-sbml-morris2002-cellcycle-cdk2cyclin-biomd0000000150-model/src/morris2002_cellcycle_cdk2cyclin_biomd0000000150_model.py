...
"""Auto-generated SBML BioModule wrapper for Morris2002_CellCycle_CDK2Cyclin.
...
class SbmlMorris2002CellcycleCdk2cyclin(biosim.BioModule):
    """BioModule wrapper for SBML model: Morris2002_CellCycle_CDK2Cyclin."""

    def __init__(self, model_path: str = "data/BIOMD0000000150.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
