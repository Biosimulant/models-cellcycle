...
"""Auto-generated SBML BioModule wrapper for Tyson1991 - Cell Cycle 6 var.
...
class SbmlTyson1991CellCycle6Var(biosim.BioModule):
    """BioModule wrapper for SBML model: Tyson1991 - Cell Cycle 6 var."""

    def __init__(self, model_path: str = "data/BIOMD0000000005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
