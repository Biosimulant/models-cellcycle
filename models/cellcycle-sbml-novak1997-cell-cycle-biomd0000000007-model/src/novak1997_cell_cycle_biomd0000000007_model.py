...
"""Auto-generated SBML BioModule wrapper for Novak1997 - Cell Cycle.
...
class SbmlNovak1997CellCycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Novak1997 - Cell Cycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000007.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
