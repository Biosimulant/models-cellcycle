...
"""Auto-generated SBML BioModule wrapper for Li2008 - Caulobacter Cell Cycle.
...
class SbmlLi2008CaulobacterCellCycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Li2008 - Caulobacter Cell Cycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000718.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
