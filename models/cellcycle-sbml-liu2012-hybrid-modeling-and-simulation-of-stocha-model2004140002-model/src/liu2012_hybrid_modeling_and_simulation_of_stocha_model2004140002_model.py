...
"""Auto-generated SBML BioModule wrapper for Liu2012-Hybrid modeling and simulation of stochastic effects on progression through the eukaryotic cell cycle..
...
class SbmlLiu2012HybridModelingAndSimulationOfStochastic(biosim.BioModule):
    ...
    def __init__(self, model_path: str = "data/MODEL2004140002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
