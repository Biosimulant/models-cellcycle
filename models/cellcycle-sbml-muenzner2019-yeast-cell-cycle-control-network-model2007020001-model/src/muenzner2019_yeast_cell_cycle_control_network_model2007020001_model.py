...
"""Auto-generated SBML BioModule wrapper for Muenzner2019 - Yeast Cell cycle control network.

Source: biomodels_ebi:MODEL2007020001
Original: https://www.ebi.ac.uk/biomodels/MODEL2007020001
"""
...
class SbmlMuenzner2019YeastCellCycleControlNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Muenzner2019 - Yeast Cell cycle control network."""

    def __init__(self, model_path: str = "data/MODEL2007020001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Muenzner2019YeastCellCycleControlNetworkModel2007020001Model = SbmlMuenzner2019YeastCellCycleControlNetwork
