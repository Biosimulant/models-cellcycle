...
"""Auto-generated SBML BioModule wrapper for Ferrel2011 - Autonomous biochemical oscillator in regulation of CDK1, Plk1, and APC in Xenopus Laevis cell cycle.
...
class SbmlFerrel2011AutonomousBiochemicalOscillatorInRegulation(biosim.BioModule):
    ...
    def __init__(self, model_path: str = "data/BIOMD0000000937.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
