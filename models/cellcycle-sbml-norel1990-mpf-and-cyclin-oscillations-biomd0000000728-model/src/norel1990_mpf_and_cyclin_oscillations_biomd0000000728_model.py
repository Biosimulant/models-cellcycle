...
"""Auto-generated SBML BioModule wrapper for Norel1990 - MPF and Cyclin Oscillations.
...
class SbmlNorel1990MpfAndCyclinOscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: Norel1990 - MPF and Cyclin Oscillations."""

    def __init__(self, model_path: str = "data/BIOMD0000000728.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
