...
"""Auto-generated SBML BioModule wrapper for Swat2004_Mammalian_G1_S_Transition.
...
class SbmlSwat2004MammalianG1STransition(biosim.BioModule):
    """BioModule wrapper for SBML model: Swat2004_Mammalian_G1_S_Transition."""

    def __init__(self, model_path: str = "data/BIOMD0000000228.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
