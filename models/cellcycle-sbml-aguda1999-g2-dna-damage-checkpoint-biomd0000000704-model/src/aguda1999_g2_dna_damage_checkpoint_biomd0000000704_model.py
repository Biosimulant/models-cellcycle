...
"""Auto-generated SBML BioModule wrapper for Aguda1999 - G2 DNA damage checkpoint.
...
class SbmlAguda1999G2DnaDamageCheckpoint(biosim.BioModule):
    """BioModule wrapper for SBML model: Aguda1999 - G2 DNA damage checkpoint."""

    def __init__(self, model_path: str = "data/BIOMD0000000704.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
