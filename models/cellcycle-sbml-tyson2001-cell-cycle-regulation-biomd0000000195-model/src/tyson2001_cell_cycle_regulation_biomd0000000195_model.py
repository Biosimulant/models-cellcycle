...
"""Auto-generated SBML BioModule wrapper for Tyson2001_Cell_Cycle_Regulation.
...
class SbmlTyson2001CellCycleRegulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Tyson2001_Cell_Cycle_Regulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000195.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
