...
"""Auto-generated SBML BioModule wrapper for Ciliberto2003_Morphogenesis_Checkpoint.
...
class SbmlCiliberto2003MorphogenesisCheckpoint(biosim.BioModule):
    """BioModule wrapper for SBML model: Ciliberto2003_Morphogenesis_Checkpoint."""

    def __init__(self, model_path: str = "data/BIOMD0000000297.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
