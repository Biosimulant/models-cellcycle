...
"""Auto-generated SBML BioModule wrapper for Csikasz-Nagy2006 - Mammalian Cell Cycle model.
...
class SbmlCsikaszNagy2006MammalianCellCycleModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Csikasz-Nagy2006 - Mammalian Cell Cycle model."""

    def __init__(self, model_path: str = "data/BIOMD0000001044.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
