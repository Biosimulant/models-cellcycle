...
"""Auto-generated SBML BioModule wrapper for Ferrel2011 - Cdk1 and APC regulation in cell cycle in Xenopus laevis.
...
class SbmlFerrel2011Cdk1AndApcRegulationInCellCycleInXenopus(biosim.BioModule):
    """BioModule wrapper for SBML model: Ferrel2011 - Cdk1 and APC regulation in cell cycle in Xenopus laevis."""

    def __init__(self, model_path: str = "data/BIOMD0000000935.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
