...
"""Auto-generated SBML BioModule wrapper for Henze2017 - A Dynamical Model for Activating and Silencing the Mitotic Checkpoint.
...
class SbmlHenze2017ADynamicalModelForActivatingAndSilencing(biosim.BioModule):
    """BioModule wrapper for SBML model: Henze2017 - A Dynamical Model for Activating and Silencing the Mitotic Checkpoint."""

    def __init__(self, model_path: str = "data/MODEL1812210002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
