...
"""Auto-generated SBML BioModule wrapper for Barrack2014 - Calcium/cell cycle coupling - Rs dependent ATP release.
...
class SbmlBarrack2014CalciumCellCycleCouplingRsDependentAtp(biosim.BioModule):
    """BioModule wrapper for SBML model: Barrack2014 - Calcium/cell cycle coupling - Rs dependent ATP release."""

    def __init__(self, model_path: str = "data/BIOMD0000000509.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
