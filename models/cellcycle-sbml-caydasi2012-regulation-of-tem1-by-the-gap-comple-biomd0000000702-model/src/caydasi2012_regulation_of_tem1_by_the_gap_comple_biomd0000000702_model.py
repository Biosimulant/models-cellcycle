...
"""Auto-generated SBML BioModule wrapper for Caydasi2012 - Regulation of Tem1 by the GAP complex in Spindle Position Checkpoint - Ubiquitous inactive model.
...
class SbmlCaydasi2012RegulationOfTem1ByTheGapComplexIn(biosim.BioModule):
    ...
    def __init__(self, model_path: str = "data/BIOMD0000000702.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
