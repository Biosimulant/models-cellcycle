...
"""Auto-generated SBML BioModule wrapper for Caydasi2012 - Regulation of Tem1 by the GAP complex in spindle position cell cycle checkpoint - Ubiquitous association model.
...
class SbmlCaydasi2012RegulationOfTem1ByTheGapComplexIn2(biosim.BioModule):
    ...
    def __init__(self, model_path: str = "data/BIOMD0000000699.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
