...
"""Auto-generated SBML BioModule wrapper for DeBoeck2021 - Modular approach to modeling the cell cycle, simple cell cycle model.
...
class SbmlDeboeck2021ModularApproachToModelingTheCellCycle(biosim.BioModule):
    """BioModule wrapper for SBML model: DeBoeck2021 - Modular approach to modeling the cell cycle, simple cell cycle model."""

    def __init__(self, model_path: str = "data/BIOMD0000001079.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
