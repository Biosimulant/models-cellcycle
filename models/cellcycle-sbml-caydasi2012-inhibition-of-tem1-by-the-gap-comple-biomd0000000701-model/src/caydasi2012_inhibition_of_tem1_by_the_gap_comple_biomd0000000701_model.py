...
"""Auto-generated SBML BioModule wrapper for Caydasi2012 - Inhibition of Tem1 by the GAP complex in Spindle Position Checkpoint.
...
class SbmlCaydasi2012InhibitionOfTem1ByTheGapComplexIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Caydasi2012 - Inhibition of Tem1 by the GAP complex in Spindle Position Checkpoint."""

    def __init__(self, model_path: str = "data/BIOMD0000000701.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
