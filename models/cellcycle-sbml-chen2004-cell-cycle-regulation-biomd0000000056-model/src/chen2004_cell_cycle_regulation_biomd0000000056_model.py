...
"""Auto-generated SBML BioModule wrapper for Chen2004 - Cell Cycle Regulation.
...
class SbmlChen2004CellCycleRegulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Chen2004 - Cell Cycle Regulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000056.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
