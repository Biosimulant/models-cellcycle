...
"""Auto-generated SBML BioModule wrapper for ferrel2011 - autonomous biochemical oscillator in cell cycle in Xenopus laevis v2.
...
class SbmlFerrel2011AutonomousBiochemicalOscillatorInCellCycle(biosim.BioModule):
    """BioModule wrapper for SBML model: ferrel2011 - autonomous biochemical oscillator in cell cycle in Xenopus laevis v2."""

    def __init__(self, model_path: str = "data/BIOMD0000000936.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
