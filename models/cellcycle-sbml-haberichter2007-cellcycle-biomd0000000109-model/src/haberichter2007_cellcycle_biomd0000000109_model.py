...
"""Auto-generated SBML BioModule wrapper for Haberichter2007_cellcycle.
...
class SbmlHaberichter2007Cellcycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Haberichter2007_cellcycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000109.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
