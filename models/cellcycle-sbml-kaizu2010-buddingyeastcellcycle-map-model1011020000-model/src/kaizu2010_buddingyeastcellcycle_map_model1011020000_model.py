...
"""Auto-generated SBML BioModule wrapper for Kaizu2010_BuddingYeastCellCycle_Map.

Source: biomodels_ebi:MODEL1011020000
Original: https://www.ebi.ac.uk/biomodels/MODEL1011020000
"""
...
class SbmlKaizu2010BuddingyeastcellcycleMap(biosim.BioModule):
    """BioModule wrapper for SBML model: Kaizu2010_BuddingYeastCellCycle_Map."""

    def __init__(self, model_path: str = "data/MODEL1011020000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kaizu2010BuddingyeastcellcycleMapModel1011020000Model = SbmlKaizu2010BuddingyeastcellcycleMap
