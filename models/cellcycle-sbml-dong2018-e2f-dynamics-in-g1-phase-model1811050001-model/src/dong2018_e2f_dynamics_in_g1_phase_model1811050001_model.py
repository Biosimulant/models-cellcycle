...
"""Auto-generated SBML BioModule wrapper for Dong2018 - E2F dynamics in G1 phase.
...
class SbmlDong2018E2fDynamicsInG1Phase(biosim.BioModule):
    """BioModule wrapper for SBML model: Dong2018 - E2F dynamics in G1 phase."""

    def __init__(self, model_path: str = "data/MODEL1811050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
