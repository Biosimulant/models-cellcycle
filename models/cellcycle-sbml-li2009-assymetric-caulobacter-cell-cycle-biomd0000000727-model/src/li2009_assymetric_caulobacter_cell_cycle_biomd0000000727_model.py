...
"""Auto-generated SBML BioModule wrapper for Li2009- Assymetric Caulobacter cell cycle.
...
class SbmlLi2009AssymetricCaulobacterCellCycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Li2009- Assymetric Caulobacter cell cycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000727.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
