...
"""Auto-generated SBML BioModule wrapper for Gerard2009 - An Integrated Mammalian Cell Cycle Model.
...
class SbmlGerard2009AnIntegratedMammalianCellCycleModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Gerard2009 - An Integrated Mammalian Cell Cycle Model."""

    def __init__(self, model_path: str = "data/BIOMD0000000730.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
