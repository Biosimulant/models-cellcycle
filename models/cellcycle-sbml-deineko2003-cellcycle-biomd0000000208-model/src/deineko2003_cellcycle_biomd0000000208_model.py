...
"""Auto-generated SBML BioModule wrapper for Deineko2003_CellCycle.
...
class SbmlDeineko2003Cellcycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Deineko2003_CellCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000208.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
