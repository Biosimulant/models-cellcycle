...
"""Auto-generated SBML BioModule wrapper for Ibrahim2008 - Mitotic Spindle Assembly Checkpoint - Dissociation variant.
...
class SbmlIbrahim2008MitoticSpindleAssemblyCheckpoint(biosim.BioModule):
    """BioModule wrapper for SBML model: Ibrahim2008 - Mitotic Spindle Assembly Checkpoint - Dissociation variant."""

    def __init__(self, model_path: str = "data/BIOMD0000000186.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
