...
"""Auto-generated SBML BioModule wrapper for Gérard - 2019 - Coupling the cell cycle and the cell transformation networks (SBML).
...
class SbmlGerard2019CouplingTheCellCycleAndTheCell(biosim.BioModule):
    """BioModule wrapper for SBML model: Gérard - 2019 - Coupling the cell cycle and the cell transformation networks (SBML)."""

    def __init__(self, model_path: str = "data/MODEL1906070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
