...
"""Auto-generated SBML BioModule wrapper for Conradie2010_RPControl_CellCycle.
...
class SbmlConradie2010RpcontrolCellcycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Conradie2010_RPControl_CellCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000265.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
