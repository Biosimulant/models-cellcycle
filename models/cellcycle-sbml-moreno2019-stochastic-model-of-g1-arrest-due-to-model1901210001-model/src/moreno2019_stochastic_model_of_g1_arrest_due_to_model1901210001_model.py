...
"""Auto-generated SBML BioModule wrapper for Moreno2019 - Stochastic model of G1 arrest due to proteostasis decline delimits replicative lifespan in yeast.
...
class SbmlMoreno2019StochasticModelOfG1ArrestDueTo(biosim.BioModule):
    ...
    def __init__(self, model_path: str = "data/MODEL1901210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
