...
"""Auto-generated SBML BioModule wrapper for Chen2000_CellCycle.
...
class SbmlChen2000Cellcycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Chen2000_CellCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000675.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
