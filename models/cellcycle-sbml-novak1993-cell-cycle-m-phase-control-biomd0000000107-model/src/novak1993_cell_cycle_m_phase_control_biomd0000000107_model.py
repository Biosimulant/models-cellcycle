...
"""Auto-generated SBML BioModule wrapper for Novak1993 - Cell cycle M-phase control.
...
class SbmlNovak1993CellCycleMPhaseControl(biosim.BioModule):
    """BioModule wrapper for SBML model: Novak1993 - Cell cycle M-phase control."""

    def __init__(self, model_path: str = "data/BIOMD0000000107.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
