...
"""Auto-generated SBML BioModule wrapper for Gerard2010 - Progression of mammalian cell cycle by successive activation of various cyclin cdk complexes.
...
class SbmlGerard2010ProgressionOfMammalianCellCycleBy(biosim.BioModule):
    ...
    def __init__(self, model_path: str = "data/BIOMD0000000941.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
