...
"""Auto-generated SBML BioModule wrapper for Novak1998-Model scenarios for evolution of the eukaryotic cell cycle..
...
class SbmlNovak1998ModelScenariosForEvolutionOfTheEukaryotic(biosim.BioModule):
    """BioModule wrapper for SBML model: Novak1998-Model scenarios for evolution of the eukaryotic cell cycle.."""

    def __init__(self, model_path: str = "data/MODEL2005040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
