...
"""Auto-generated SBML BioModule wrapper for Bedessem2014 - HiF-1 a -mediated response to hypoxia on the G1/S transition.
...
class SbmlBedessem2014Hif1AMediatedResponseToHypoxiaOnTheG1(biosim.BioModule):
    """BioModule wrapper for SBML model: Bedessem2014 - HiF-1 a -mediated response to hypoxia on the G1/S transition."""

    def __init__(self, model_path: str = "data/MODEL1812040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
