...
"""Auto-generated SBML BioModule wrapper for Chiorino2002 - G1/S transition model.
...
class SbmlChiorino2002G1STransitionModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Chiorino2002 - G1/S transition model."""

    def __init__(self, model_path: str = "data/MODEL2003180003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
