...
"""Auto-generated SBML BioModule wrapper for Model of budding yeast critical cell size dependence on growth rate with parameter set 3114.
...
class SbmlModelOfBuddingYeastCriticalCellSizeDependenceOn(biosim.BioModule):
    ...
    def __init__(self, model_path: str = "data/MODEL1808310001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
