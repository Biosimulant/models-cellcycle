...
"""Auto-generated SBML BioModule wrapper for Tyson1991 - Cell Cycle 2 var.
...
class SbmlTyson1991CellCycle2Var(biosim.BioModule):
    """BioModule wrapper for SBML model: Tyson1991 - Cell Cycle 2 var."""

    def __init__(self, model_path: str = "data/BIOMD0000000006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
