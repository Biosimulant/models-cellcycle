...
"""Auto-generated SBML BioModule wrapper for Novak1998 - Mathematical model of fission yeast cell cycle.
...
class SbmlNovak1998MathematicalModelOfFissionYeastCellCycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Novak1998 - Mathematical model of fission yeast cell cycle."""

    def __init__(self, model_path: str = "data/MODEL2003190004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
