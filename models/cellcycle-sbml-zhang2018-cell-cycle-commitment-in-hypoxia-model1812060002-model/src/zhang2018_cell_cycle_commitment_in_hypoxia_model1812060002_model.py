...
"""Auto-generated SBML BioModule wrapper for Zhang2018 - Cell cycle commitment in hypoxia.
...
class SbmlZhang2018CellCycleCommitmentInHypoxia(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhang2018 - Cell cycle commitment in hypoxia."""

    def __init__(self, model_path: str = "data/MODEL1812060002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
