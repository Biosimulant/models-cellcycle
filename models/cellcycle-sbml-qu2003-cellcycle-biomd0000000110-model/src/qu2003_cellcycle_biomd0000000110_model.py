...
"""Auto-generated SBML BioModule wrapper for Qu2003_CellCycle.
...
class SbmlQu2003Cellcycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Qu2003_CellCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000110.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
