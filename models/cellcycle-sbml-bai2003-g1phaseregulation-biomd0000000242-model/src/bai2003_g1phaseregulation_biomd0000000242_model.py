...
"""Auto-generated SBML BioModule wrapper for Bai2003_G1phaseRegulation.
...
class SbmlBai2003G1phaseregulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Bai2003_G1phaseRegulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000242.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
