...
"""Auto-generated SBML BioModule wrapper for Tsai2014 - Cell cycle duration control by oscillatory Dynamics  in Early Xenopus laevis Embryos.
...
class SbmlTsai2014CellCycleDurationControlByOscillatory(biosim.BioModule):
    ...
    def __init__(self, model_path: str = "data/BIOMD0000000719.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
