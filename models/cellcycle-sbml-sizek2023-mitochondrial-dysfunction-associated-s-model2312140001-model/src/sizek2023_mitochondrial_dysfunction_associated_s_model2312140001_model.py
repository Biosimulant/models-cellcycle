...
"""Auto-generated SBML BioModule wrapper for Sizek2023 - Mitochondrial Dysfunction-Associated Senescence (MiDAS) with cell cycle and apoptosis.

Source: biomodels_ebi:MODEL2312140001
Original: https://www.ebi.ac.uk/biomodels/MODEL2312140001
"""
...
class SbmlSizek2023MitochondrialDysfunctionAssociatedSenescence(biosim.BioModule):
    """BioModule wrapper for SBML model: Sizek2023 - Mitochondrial Dysfunction-Associated Senescence (MiDAS) with cell cycle and apoptosis."""

    def __init__(self, model_path: str = "data/MODEL2312140001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sizek2023MitochondrialDysfunctionAssociatedSModel2312140001Model = SbmlSizek2023MitochondrialDysfunctionAssociatedSenescence
