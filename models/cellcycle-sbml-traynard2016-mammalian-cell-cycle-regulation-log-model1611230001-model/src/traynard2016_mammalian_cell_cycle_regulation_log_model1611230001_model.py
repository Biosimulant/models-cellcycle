...
"""Auto-generated SBML BioModule wrapper for Traynard2016 - Mammalian cell cycle regulation - Logical Model.

Source: biomodels_ebi:MODEL1611230001
Original: https://www.ebi.ac.uk/biomodels/MODEL1611230001
"""
...
class SbmlTraynard2016MammalianCellCycleRegulationLogicalModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Traynard2016 - Mammalian cell cycle regulation - Logical Model."""

    def __init__(self, model_path: str = "data/MODEL1611230001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Traynard2016MammalianCellCycleRegulationLogModel1611230001Model = SbmlTraynard2016MammalianCellCycleRegulationLogicalModel
