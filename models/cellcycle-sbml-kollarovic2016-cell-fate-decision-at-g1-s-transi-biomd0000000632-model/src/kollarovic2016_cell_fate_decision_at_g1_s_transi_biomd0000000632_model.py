...
"""Auto-generated SBML BioModule wrapper for Kollarovic2016 - Cell fate decision at G1-S transition.
...
class SbmlKollarovic2016CellFateDecisionAtG1STransition(biosim.BioModule):
    """BioModule wrapper for SBML model: Kollarovic2016 - Cell fate decision at G1-S transition."""

    def __init__(self, model_path: str = "data/BIOMD0000000632.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
